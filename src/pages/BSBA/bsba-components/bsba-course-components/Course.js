...
import students from '../BAimages/bsba-course-images/bsba1.jpg';
        ...
        <div className="relative  lg:py-11 text-gray-700  grid  lg:grid-cols-5 grid-cols-1 lg:gap-4 bg-white"> 
                <div className=' col-start-1 col-end-6 mb-[3rem]'>
                    <div className='grid lg:grid-cols-2 grid-cols-1 mt-[1rem]'>
                        ...
                        <div className=' font-para px-[2rem] py-[2rem]   bg-gray-100 '>
                            <h1 className=' font-semibold text-blue-900 text-[2rem] py-[2rem]'>Bachelor of Science in Business Administration</h1>
            ...
            <div  className=' col-start-1 col-end-2 ' > 
                <div className='sticky hidden lg:block top-[2rem] bg-blue-950 p-4 py-11 rounded-xl'  >
                    <h1 className={`font-title text-[2rem] cursor-pointer  flex items-center justify-center  ${isOpenweb ? 'underline decoration-yellow-400 text-white' : 'text-white'}`} onClick={handleClick}>
