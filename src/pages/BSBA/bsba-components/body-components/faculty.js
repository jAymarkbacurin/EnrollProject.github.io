...
<div className='font-para pt-[4rem]  mx-[2rem]'>
    <h1 className='text-[1.8rem] font-bold text-blue-900 '>Our Faculty</h1>
    <p className='sm:max-w-[70%] 2xl:max-w-[90%] py-4 text-[1.1rem] text-gray-950'>Meet your dedicated teachers, the guiding force behind your academic journey. With passion, expertise, and a commitment to your success, they're here to inspire and support you every step of the way.</p>
</div>
