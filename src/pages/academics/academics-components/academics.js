...
<section className='bg-blue-100'>
    ...
    <div className='md:w-[26rem] w-[23rem] mx-auto border-b-[8px] border-yellow-500'><h1 className=' font-title md:text-[4rem] text-[3.6rem] text-gray-800'>PROGRAMS WE OFFER</h1></div>
    
    <div className=' flex justify-center md:p-[3rem] p-4'><p className='w-[60rem] text-center font-para md:text-[1.2rem] text-[1rem] text-gray-800'>
            ...
            <div className=''>
                ...
                <NavLink to={item.to} onClick={scrollToTop}>
                    <span className='flex justify-center p-1 group-hover:text-white text-gray-400  '>
                        ...
                        <h1 id='lineY' className='text-[1rem] font-semititle font-semibold mt-[5px] text-gray-400 group-hover:text-white '>Enroll Now</h1>
                    </span>
                    </NavLink>
                </div>
            </div>
...
{/* Side menu big screen */}
      ...
      <section className='bg-blue-100 my-12'>
      ...
      <aside className="   3xl:mx-[18rem] md:mx-[4rem] grid lg:grid-cols-2 grid-cols-1 gap-[30px]">
              ...
              <section className='grid md:grid-rows-3 grid-rows-1 mx-1  md:border-l-2 border-white justify-self-center '>
