            ...
            <div  className=" relative w-full lg:h-[45rem]  h-[40rem]  mx-auto  2xl:px-[7rem] xl:px-[10rem] lg:px-[6rem] px-[1rem]  pt-[4rem]">
                    ...
                    <div className=' col-start-1 col-span-6   border-b-[1px]  border-gray-300 md:p-[2rem] p-[1rem] mt-[2rem]'>
                      <div className="grid md:grid-cols-5 ">
                        ...
                        <ul className="font-para text-[1.5rem] pt-[30px] p-[1rem] sm:block hidden sticky top-0 text-gray-950">
                   ...
                   <div id="id1" className="col-start-2  col-span-4  pb-[2rem]  xl:px-[2rem] text-gray-950">

                          <h1 className="font-title 2xl:text-[5rem] text-[4rem] text-gray-800 ">WELCOME TO DATA CENTER</h1>
                      ...
                      <section  className=" pt-[4rem]">
                       ...
                       <section >
                        <div id="id3" className='font-para pt-[4rem]  mx-[2rem]'>
                            <h1 className='text-[4.8rem]  text-gray-800 font-title flex justify-start'>LEADERS</h1>
                            <p className='sm:max-w-[70%] 2xl:max-w-[80%] py-4 text-[1.2rem]  text-left'>Meet your dedicated teachers, the guiding force behind your academic journey. With passion, expertise, and a commitment to your success, they're here to inspire and support you every step of the way.</p>
                        </div>
                                ...
                                {[
                                    ...
                                    <div key={index} className='font-para text-[1.3rem] 2xl:pt-[3rem] py-[1rem]'>
                                        ...
                                        <div className='p-4  mt-[1rem]'>
                                            <h1 className='flex justify-center text-center  pb-2 underline decoration-yellow-500 text-gray-950'> {faculty.name}</h1>
                                            <p className='text-center font-title tracking-widest text-[1rem] text-gray-950'>{faculty.discription}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
