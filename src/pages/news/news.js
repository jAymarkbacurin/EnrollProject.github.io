...
const NewsPage = () => {
    return ( 
      ...
      <div className='flex justify-center items-center'>
        ...
        <div className='relative max-w-[90rem] h-auto  '>
          <img 
          src={news}
      ...
      <div className=' col-start-2 col-span-7'>
       {[
            ...
            <section key={index} className="  p-[2rem]">
              ...
              <section className="grid grid-cols-2 cursor-pointer   ">
              <div className="w-full max-h-[25rem] ">
                  <img
                      className="w-full h-full rounded-lg object-cover group-hover:scale-110 ease-in-out  duration-700 transform "
                      src={News.imgSrc}
                      alt={News.title}
                  />
              </div>
              <div  >
                <div className='p-[15px] pl-[50px]'>
                  ...
                  <p className="font-para text-[1.4rem] text-gray-800 font-semibold py-[10px] group-hover:underline decoration-yellow-500">
                      {News.text}
                  </p>
                  <p className="font-para  text-[1rem] py-[10px] text-gray-600">{News.description}</p>
                  </div>
                 
                  <p className="font-para text-[15px]  text-gray-500  p-[20px] px-[50px]">
                      {News.date}
                  </p>
              </div>
          </section>
