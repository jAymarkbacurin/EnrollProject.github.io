...
<div >
    ...
    <div className='grid lg:grid-cols-3 grid-cols-2 gap-[2rem] mx-[2rem] '>
        {[
            ...
            { name: 'Soren Smith', imgSrc: soren, discription: 'Assistant Professor of Information Technology'  },
            { name: 'Zed Zim', imgSrc: zed, discription: 'Assistant Professor of Information Technology'  },
          
        ].map((faculty, index) => (
            <div key={index} className='font-para text-[1.3rem] 2xl:py-[3rem] py-[1rem]'>
                ...
                <div className='p-4 border-t-2 border-b-2 border-gray-400 mt-[1rem]'>
