...
import HM from '../bshm-course-images/HM.jpg';
    ...
    return ( 
        <div className="bg-gray-900">
            ...
            <div id='container' className='bg-gray-800 md:my-11 my-2 relative overflow-hidden  lg:mx-4'>
                <div class='image'>
                    <img className="object-cover w-full h-full   " src={HM} alt="Bsit1" />
                </div>
                <div className=' p-4 my-5'>
                    <div class='lineh1 w-[10rem]'>
                        <h1 className='font-title text-[2rem] font-medium text-yellow-500'>Mission</h1>
                    </div>
           ...
           <div id='container' className='bg-gray-800 md:my-11 my-2 relative overflow-hidden  lg:mx-4'>
                ...
                <div className=' p-4 my-5'>
                    <div class='lineh1 w-[10rem]'>
                        <h1 className='font-title text-[2rem] font-medium text-yellow-500'>Vission</h1>
                    </div>
