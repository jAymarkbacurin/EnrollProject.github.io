...
import './stylee.css';
import Bsit1 from './BAimages/bsba-course-images/bsba1.jpg';
import Bsbacard from './bsba-course-components/cardsba';
...
const BSBA = () => {    
    ...
    return (
        ...
        <section className='w-full h-[38rem] relative top-0'>
            <div className="bg-parallax1ba bg-fixed absolute inset-0 bg-cover brightness-50 "></div>
            <div className="absolute inset-0 flex justify-center items-center text-center">
            <div>
                <div className='flex'>
                   <NavLink to='/bshm' >
                        <div className=' mx-1 cursor-pointer'>
                            <IoIosArrowDropleft className='mr-3  text-white hover:text-yellow-400' size={iconSize1} />
                        </div>
                    </NavLink>
                ...
                <h1 className='text-gray-300 font-bold font-semititle cursor-pointer hover:text-blue-500'>
                    <span className="inline-block align-middle mr-6"></span> 
                   Welcome to BA Department
                    </h1>  
            </div>   
                <NavLink to='/bsit' >
                            <div className=' mx-1  cursor-pointer mt-[5.5rem]'>
                                <IoIosArrowDropright  className='mr-3 text-white hover:text-violet-500' size={iconSize1} />
                            </div>
                </NavLink>
            </div>
        </section>
...
<div className=' bg-gray-100'>
                    <div className='flex justify-center items-center pt-6 font-semititle font-medium  ' >
                        <h1 className='p-1 px-7 mx-1 border-[1px] border-blue-700 text-blue-700 rounded-2xl hover:border-blue-400 hover:text-blue-400 cursor-pointer '>  Core Subject </h1>
                        <h1 className='p-1 px-7 mx-1 border-[1px] border-blue-700 text-blue-700 rounded-2xl hover:border-blue-400 hover:text-blue-400  cursor-pointer '>  Requirements </h1>
                        <h1 className='p-1 px-7 mx-1 border-[1px] border-blue-700 text-blue-700 rounded-2xl hover:border-blue-400 hover:text-blue-400  cursor-pointer'>  Contacts </h1>
                    </div>
    ...
    <section className=" p-1 my-11 py-5 mx-2  rounded-lg  ">
                    ...
                    <div className='grid md:grid-cols-2 grid-cols-1 text-gray-700'>
                        <div id='bsitMW' className='lg:mx-11  mx-2 mt-7  ' >
                            <div className='relative lg:h-[5rem] h-[4rem]  w-[27.7rem]  lg:w-[35rem] text-[2.5rem] lg:text-[3rem] drop-shadow-lg font-title text-gray-300'>Financial Management
                                <h1 className=' absolute p-4 -left-7 -top-6  font-title  text-[2.5rem] lg:text-[3rem]  text-blue-800 '> 
                                Financial Management</h1>
                            </div>
                        </div>
                        <div className='md:mt-8 font-para font-semibold'>
                    ...
                    <hr className="border-t-[6px] border-blue-800  mt-4 w-full  " />
 ...
 {/*financial management =======================financial management==============================================*/}
        <div class="grid lg:grid-cols-3 grid-cols-1  my-3 lg:my-11">
                            ...
                            hover:brightness-90 ">
                                ...
                                <div className="absolute bg-gradient-to-t from-black w-full h-full transform duration-500 inset-y-1/3 group-hover:-inset-y-0">
                                    ...
                                    <div class="absolute w-full bottom-11 flex justify-center  cursor-pointer ">
                                        <span className='flex justify-center  p-1 hover:text-blue-600  text-white '>
                ...
                <div class=" col-span-2 p-4">
                    <div id='bsitMW' className='lg:mx-11  mx-1 mt-7  ' >
                        <div className='relative  h-[5rem] w-[23.5rem] bg-gray-300 drop-shadow-lg '>
                            <h1 className=' absolute p-4 -left-4 -top-4 bg-blue-800  font-title text-white text-[2rem]  '>
                           Financial Management </h1>
                        </div>
                    </div>
                        ...
                        <div className='p-4 font-para  md:mx-8 mt-1 text-justify  text-gray-800 font-medium md:font-normal'>
                            ...
                            <div className='  md:mt-8'>
                                <div class="w-full bottom-11  flex  cursor-pointer py-2  ">
                                    <span className='flex justify-center p-1 hover:text-blue-400 md:hover:text-blue-700  text-blue-800   '> 
