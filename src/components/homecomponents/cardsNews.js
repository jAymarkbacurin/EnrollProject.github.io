        ...
        <div class="container mx-auto my-[6rem] ">
            <div class="grid grid-cols-1 md:grid-cols-2 w-full mb-3 p-3 mx-5   ">
                <hr class="w-[60rem]  my-8  border-0 " />
                    <h1 class="absolute   text-blue-900 text-[2.6rem] font-meduim font-title ">
                       <NavLink to="/news">
                          News & Events
                       </NavLink>
                    </h1>
                    <button className=' lg:justify-self-end justify-self-start mr-9 rounded-full font-medium
