...
const Courses = () => {
 ...
 {/* BSBA*/}
      <section className="flex md:mx-[3rem] xl:mx-[15rem] mt-[8rem]">
        <section className="flex-grow flex-col p-1">
          <section  className="justify-center relative mb-11 ">
            <section id='business-administration'>
                  <div class="relative group w-full lg:h-[25rem] overflow-hidden bg-black rounded-2xl">
          ...
          <div className='p-9 font-semititle '>
